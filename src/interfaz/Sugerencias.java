...
public class Sugerencias extends JFrame implements ActionListener {
	...
	public Sugerencias(){
		...
		txtInstruccion = new JTextArea("Para nostros es muy importante saber qué piensan los usuarios de esta aplicación, "
				+ "¿qué dicues tú? Escribe aquí tu sugerencia");
		txtInstCorr = new JTextArea("Para recibir tu sugerencia necesitamos un correo electrónico para contactarte");
		...
		txtInstCorr.setPreferredSize(new Dimension(100, 40));
		System.out.println("uno");
		txtDescripcion.setPreferredSize(new Dimension(100, 40));
		System.out.println("dos");
		txtEmail.setPreferredSize(new Dimension(100, 40));
		
		txtInstCorr.setBorder(BorderFactory.createLineBorder(Color.black));
		...
		condiciones.gridx = 2;
		condiciones.gridy = 5;
		panel.add(this.btnRegresar, condiciones);
		condiciones.weightx = 1.0;
